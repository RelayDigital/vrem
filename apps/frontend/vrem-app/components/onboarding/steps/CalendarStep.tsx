...
export function CalendarStep() {
  ...
  const handleConnectGoogle = () => {
    // Mark intent to connect calendar - actual OAuth happens after account creation
          ...
          {data.accountType === "PROVIDER" ? (
            <>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>Automatic availability sync</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Check className="w-4 h-4 text-primary flex-shrink-0" />
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Check className="w-4 h-4 text-primary flex-shrink-0" />
                <span>Client scheduling integration</span>
              </li>
            </>
          ) : (
            <>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Check className="w-4 h-4 text-primary flex-shrink-0" />
                <span>Automatic shoot reminders</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Check className="w-4 h-4 text-primary flex-shrink-0" />
        ...
        <DialogContent>
          <DialogHeader>
            <div className="flex items-center gap-3">
              ...
              <DialogTitle>Skip calendar connection?</DialogTitle>
            </div>
            <DialogDescription className="pt-2">
              {data.accountType === "PROVIDER"
                ? "Without calendar sync, you'll need to manually manage your availability. This may lead to double-bookings."
                : "Without calendar sync, you won't get automatic reminders for your scheduled shoots."}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
