...
export function MetricsDashboard({ metrics }: MetricsDashboardProps) {
  const utilizationPercent = Math.round(metrics.photographers.utilization * 100);
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {metrics.photographers.available}/{metrics.photographers.active} available
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl">{metrics.performance.averageDeliveryTime}h</div>
            <p className="text-xs text-muted-foreground mt-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-3">
              {Math.round(metrics.jobs.completed * metrics.performance.onTimeRate)} of{' '}
              {metrics.jobs.completed} jobs delivered on time
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-4">
              <div className="flex-1">
                <div className="text-3xl">{metrics.performance.clientSatisfaction}/5.0</div>
                <Progress
