...
import { ChevronsUpDown, SettingsIcon, UserIcon, ChevronDownIcon } from 'lucide-react';
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbList,
...
const SettingsMenu = ({ onItemClick }: { onItemClick?: (item: string) => void }) => (
  <DropdownMenu>
...
// Types
export interface Navbar11NavItem {
  href?: string;
  label: string;
}

export interface Navbar11AccountType {
  value: string;
  label: string;
}

export interface Navbar11Project {
  value: string;
  label: string;
}

export interface Navbar11Props extends React.HTMLAttributes<HTMLElement> {
  navigationLinks?: Navbar11NavItem[];
  accountTypes?: Navbar11AccountType[];
  defaultAccountType?: string;
  projects?: Navbar11Project[];
...
const defaultNavigationLinks: Navbar11NavItem[] = [
...
const defaultAccountTypes: Navbar11AccountType[] = [
...
// Default projects
const defaultProjects: Navbar11Project[] = [
  { value: '1', label: 'Main project' },
  { value: '2', label: 'Origin project' },
];

export const Navbar11 = React.forwardRef<HTMLElement, Navbar11Props>(
  (
    {
      className,
